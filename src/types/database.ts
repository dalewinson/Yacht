...
export interface Database {
  public: {
    Tables: {
      ...
      tickets: {
        Row: { id: string; vessel_id: string; title: string; description: string | null; status: TicketStatus; priority: TicketPriority; source: TicketSource; category: string | null; assigned_to: string | null; reported_by: string | null; resolution: string | null; equipment_id: string | null; inspection_ref: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; vessel_id: string; title: string; description?: string | null; status?: TicketStatus; priority?: TicketPriority; source?: TicketSource; category?: string | null; assigned_to?: string | null; reported_by?: string | null; resolution?: string | null; equipment_id?: string | null; inspection_ref?: string | null }
        Update: { title?: string; description?: string | null; status?: TicketStatus; priority?: TicketPriority; category?: string | null; assigned_to?: string | null; reported_by?: string | null; resolution?: string | null; equipment_id?: string | null; inspection_ref?: string | null }
      }
      ticket_attachments: {
